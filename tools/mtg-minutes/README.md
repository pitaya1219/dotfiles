...
| ツール | 用途 | 確認 |
|--------|------|------|
| ffmpeg | 音声抽出・変換 | `which ffmpeg` |
| whisper-cpp | 文字起こし | `which whisper-cli` |
| claude (CLI) | 議事録生成 | `which claude` |
| whisperモデル | `~/.cache/whisper-cpp/models/ggml-large-v3-turbo.bin` | 約1.5GB |
